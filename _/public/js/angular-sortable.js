// (function(angular) {
//   var module = angular.module('angudrag')
//   module.directive('angudrag-dropzone', function() {
//     return {
//       restrict: 'A',
//       scope: {
//         overClass: '=angudragOverClass',
//         onDrop: '=angudragDrop',
//         onOver: '=angudragOnOver'
//       },
//       link: function(scope, el, attrs) {
//         var angudrag = {};

//         angudrag.settings =  {
//           overClass: scope.overClass || 'over',
//           onDrop: scope.onDrop || function() {},
//           onOver: scope.onOver || function() {}
//         }

//         angudrag.drop = function() {
//           angular.element(el).classList.remove('over');
//         }
//         angudrag.dragEnter = function() {
//           angular.element(el).classList.add('over');
//         }
//         angudrag.dragOver = function() {
//           angular.element(el).classList.add('over');
//         }
//         angudrag.dragLeave = function() {
//           angular.element(el).classList.remove('over');
//         }

//         el.addEventListener('drop', angudrag.handleDrop);
//         el.addEventListener('dragenter', angudrag.handleDragEnter);
//         el.addEventListener('dragover', angudrag.handleDragOver);
//         el.addEventListener('dragleave', angudrag.handleDragLeave);
//       }
//     }
//   });
//   module.directive('angudrag-item', function() {
//     return {
//       restrict: 'A',
//     }
//   });
//   module.directive('angudrag-container', function() {
//     return {
//       restrict: 'A',
//       scope: {
//         'data': 'angudrag-data'
  ...
  return {
    ...
    link: function(scope, element, attrs,ngModel) {
      ...
      sortable.handleDragStart = function(e) {
        ...
        if ( sortable.options &&  angular.isDefined(sortable.options.start) ){
            $log.info('Make callback');
            sortable.options.start(ngModel.$modelValue,drop_index,
